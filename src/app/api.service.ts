...
export class ApiService {
  ...
  public updateUserPassword(password: string, userid: number, recoveryOrOldPassword: string): Observable<{ success: boolean }> {
    if (typeof recoveryOrOldPassword !== 'undefined') {
  ...
  public createUser(userEmail: string, userAlias: string, userPassword: string): Observable<{ success: boolean, message: string }> {
    const usr = { email: userEmail, alias: userAlias, password: userPassword };
